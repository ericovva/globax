...
THREE.GPUParticleSystem = function( options ) {
	...
	this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( 'static/main/img/webgl/perlin-512.png' );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'static/main/img/webgl/particle2.png' );
...
THREE.GPUParticleContainer = function( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function( options ) {
		...
		color = options.color !== undefined ? color.set( options.color ) : color.set( 0xf2c1a3 );
